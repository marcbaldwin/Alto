...
public extension Array where Element: UIView {
    ...
    @discardableResult
    func set(_ attr1: Size, _ relation: Relation, _ view: UIView, _ attr2: Size, priority: Priority? = nil, isActive: Bool = true) -> [NSLayoutConstraint] {
        return flatMap { $0.set(attr1, relation, view, attr2, priority: priority, isActive: isActive) }
    }

    @discardableResult
    func set(_ attr1: Size, _ relation: Relation, _ view: UIView, _ attr2: MultiplierOffset<Size>, priority: Priority? = nil, isActive: Bool = true) -> [NSLayoutConstraint] {
        return flatMap { $0.set(attr1, relation, view, attr2, priority: priority, isActive: isActive) }
    }

    @discardableResult
    func set(same attr: Size, priority: Priority? = nil, isActive: Bool = true) -> [NSLayoutConstraint] {
