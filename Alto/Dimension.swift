...
public extension UIView {
    ...
    @discardableResult
    func set(_ attr1: Dimension, _ relation: Relation, _ view: UIView, _ attr2: Dimension, priority: Priority? = nil, isActive: Bool = true) -> NSLayoutConstraint {
        return NSLayoutConstraint(self, attr1, relation, view, attr2, priority: priority, isActive: isActive)
    }

    @discardableResult
    func set(_ attr1: Dimension, _ relation: Relation, _ view: UIView, _ attr2: MultiplierOffset<Dimension>, priority: Priority? = nil, isActive: Bool = true) -> NSLayoutConstraint {
        return NSLayoutConstraint(self, attr1, relation, view, attr2, priority: priority, isActive: isActive)
    }

    @discardableResult
    func set(_ attr: Dimension, _ relation: Relation, _ constant: CGFloat, priority: Priority? = nil, isActive: Bool = true) -> NSLayoutConstraint {
...
public extension Array where Element: UIView {
    ...
    @discardableResult
    func set(same attr: Dimension, priority: Priority? = nil, isActive: Bool = true) -> [NSLayoutConstraint] {
