...
public extension Array where Element: UIView {
    ...
    @discardableResult public func stack(_ attribute: Stack, in view: UIView? = nil, margin: CGFloat = 0, containerMargin: CGFloat = 0, isActive: Bool = true) -> [NSLayoutConstraint] {
